...
import kr.co.point.common.dto.main.MagazineBannerDTO
...
data class MagazineBanner(
    ...
    fun toDTO() : MagazineBannerDTO {
        return MagazineBannerDTO(
            idx!!,
            bannerImg.toDTO(),
            detailImg.toDTO(),
            url,
