...
import kr.co.point.common.dto.partners.response.PartnersProductInfoDTO
...
data class PartnersProductOption(
    ...
    fun toDTO() : PartnersProductInfoDTO{
        return PartnersProductInfoDTO(
            idx,name,value,showYn
        )
    }
